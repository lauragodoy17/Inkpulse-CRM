...
if ($_POST["usuario"]==0) {
header('Content-Disposition: attachment; filename="pedidos_sin_adopcion_lal_general.xlsx"');
}else{
	header('Content-Disposition: attachment; filename="pedidos_sin_adopcion_lal_'.$usuario["nombre_c"].'.xlsx"');
}
