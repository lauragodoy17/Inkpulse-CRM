...
$estilo_negrita = array(
	...
	$objSpreadsheet->getActiveSheet()->SetCellValue("E1", "Reporte devoluciones de muestras");
...
header('Content-Disposition: attachment; filename="devoluciones_muestras.xlsx"');
