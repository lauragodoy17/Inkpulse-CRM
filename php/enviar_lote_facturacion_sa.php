<?php
/**
 * Botón "Enviar por correo" de lista_pedidos_sa.php?tp=6 (Procesando):
...
if (empty($rows)) efs_redirect('warn', 'No hay pedidos pendientes de enviar por correo a comercial@somoseureka.com.co.');
