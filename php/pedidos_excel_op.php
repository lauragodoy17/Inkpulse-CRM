...
if ($_POST["usuario"]==0) {
	header('Content-Disposition: attachment; filename="pedidos_con_adopcion_op.xlsx"');
}else{
	header('Content-Disposition: attachment; filename="pedidos_con_adopcion_op_'.$usuario["nombre_c"].'.xlsx"');
}
